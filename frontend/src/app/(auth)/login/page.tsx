      ...
      <div className="w-full max-w-sm">
        <Card className="border-border/50 shadow-lg">
          <CardHeader className="space-y-1.5 text-center pb-4">
            ...
            <CardDescription className="text-xs">Sign in to your AI Document Operations account</CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              {(error || loginError) && (
                <div className="flex items-start gap-2 rounded-lg bg-destructive/8 p-3 text-sm text-destructive">
                  ...
                  <span>{error || (loginError instanceof ApiError ? (typeof loginError.body === 'object' && loginError.body && 'detail' in loginError.body ? String(loginError.body.detail) : loginError.message) : 'Login failed.')}</span>
                </div>
              )}
