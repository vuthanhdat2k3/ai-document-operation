...
class Document(Base, UUIDMixin, TimestampMixin, SoftDeleteMixin):
    ...
    pages = relationship("DocumentPage", back_populates="document", cascade="all, delete-orphan", lazy="noload")
    chunks = relationship("DocumentChunk", back_populates="document", cascade="all, delete-orphan", lazy="noload")
    extracted_fields = relationship("ExtractedField", back_populates="document", cascade="all, delete-orphan", lazy="noload")
    risk_items = relationship("RiskItem", back_populates="document", cascade="all, delete-orphan", lazy="noload")
